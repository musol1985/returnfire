...
@ModelEntity
public class ExtractorHierroModel extends EdificioExtractorModel<ExtractorHierroDAO, ExtractorHierroNode>{
	
    @Entity
    public ExtractorHierroNode building;
    
    @Override
    public ExtractorHierroNode getNodo() {
        return building;
    }
